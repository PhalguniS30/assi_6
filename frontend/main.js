...
$(function(){
  ...
  var backendHostUrl = 'https://backend-dot-user-authentication-509ed.appspot.com';

  // [START gae_python_firenotes_config]
  // Obtain the following from the "Add Firebase to your web app" dialogue
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyA-qkSaLhrQOuwj48fHtm8H4KBCw8pVAZQ",
    authDomain: "user-authentication-509ed.firebaseapp.com",
    projectId: "user-authentication-509ed",
    storageBucket: "user-authentication-509ed.appspot.com",
    messagingSenderId: "168841847365",
    appId: "1:168841847365:web:ecfa87b6a52f0235c3f92c",
    measurementId: "G-F6L1NVTF7Y"
  };
